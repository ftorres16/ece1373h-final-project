...
int main() {
  bool passed = true;
  string src_file = "tb_data/spike_deepclassifier.txt";
  ...
  SPIKE_DEEPETECTOR_MEM_PARAMS sd_mem_params;
  ...
  int electrodes_offset[n_electrodes] = {
      inputs_offset, inputs_offset + int(2 * 48 * 20 * sizeof(float)),
      inputs_offset + int(3 * 48 * 20 * sizeof(float))};
