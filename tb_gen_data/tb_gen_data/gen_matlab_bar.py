...
class GenMatlabBAR(GenBase):
    def __init__(self, name: str, out_folder: str = OUTPUT_FOLDER):
        ...
        self.pytorch_model = ConvertModel(self.onnx_model)

    def gen_input(
        self, batch_size: int = 1, in_d: int = 1, in_y: int = 1, in_x: int = 48
    ):
